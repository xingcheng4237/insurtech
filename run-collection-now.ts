...
async function runCollection() {
  ...
  try {
    ...
    const { saveArticles, saveReport, createCollectionLog } = await import('./server/db');
    ...
    console.log(`✓ Collected ${result.articles.length} articles in ${result.collectionTime}s`);
    ...
    console.log('Duration:', ((endTime.getTime() - startTime.getTime()) / 1000).toFixed(2), 'seconds');
    console.log('View at: https://3000-iqk9ivytp0ejto7yfld64-ca1b18b7.manus-asia.computer/latest');
